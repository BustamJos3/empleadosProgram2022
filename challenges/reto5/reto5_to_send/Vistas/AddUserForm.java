...
public class AddUserForm extends javax.swing.JDialog {
    ...
    ComboBoxModel enumTipoDocumento, enumOcupacion;
    ...
    public AddUserForm(java.awt.Frame parent, boolean modal) {
        ...
        //every time view is visible activate controller and load from which is selected by user
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(cbOcupacion, javax.swing.GroupLayout.PREFERRED_SIZE, 207, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        if (nombre.isEmpty() || apellidos.isEmpty() || documento.isEmpty() || email.isEmpty()) {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    String queryNuevoEmpleado = "INSERT INTO `empleado`(`nombreEmp`, `apellidos`,`tipoDocumento`, `documento`, `correo`,`FK_idSucursal`, FK_idPuestoTrabajo) VALUES ('" + nombre + "','" + apellidos + "','" + tipoDocumento + "','" + documento + "','" + email + "'," + idSucursal + "" + "," + idPuestoTrabajo + ")";
